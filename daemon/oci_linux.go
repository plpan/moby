...
func (daemon *Daemon) createSpec(c *container.Container) (*specs.Spec, error) {
	...
	parent := "/docker"
	fmt.Printf("%#v\n", daemon.configStore)
	// &daemon.Config{CommonConfig:daemon.CommonConfig{AuthorizationPlugins:[]string(nil), AutoRestart:true, Context:map[string][]string(nil), DisableBridge:false, DNS:[]string(nil), DNSOptions:[]string(nil), DNSSearch:[]string(nil), ExecOptions:[]string(nil), GraphDriver:"overlay2", GraphOptions:[]string{"overlay2.override_kernel_check=1"}, Labels:[]string(nil), Mtu:1500, Pidfile:"/var/run/docker.pid", RawLogs:false, Root:"/home/docker_rt", SocketGroup:"docker", TrustKeyPath:"/etc/docker/key.json", CorsHeaders:"", EnableCors:false, LiveRestoreEnabled:true, ClusterStore:"", ClusterOpts:map[string]string(nil), ClusterAdvertise:"", MaxConcurrentDownloads:(*int)(0xc00014e8b0), MaxConcurrentUploads:(*int)(0xc00014e8b8), ShutdownTimeout:15, Debug:true, Hosts:[]string{"unix:///var/run/docker.sock"}, LogLevel:"info", TLS:false, TLSVerify:false, CommonTLSOptions:daemon.CommonTLSOptions{CAFile:"", CertFile:"", KeyFile:""}, SwarmDefaultAdvertiseAddr:"", MetricsAddress:"", LogConfig:daemon.LogConfig{Type:"json-file", Config:map[string]string(nil)}, bridgeConfig:daemon.bridgeConfig{commonBridgeConfig:daemon.commonBridgeConfig{Iface:"", FixedCIDR:""}, commonUnixBridgeConfig:daemon.commonUnixBridgeConfig{DefaultIP:net.IP{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xff, 0xff, 0x0, 0x0, 0x0, 0x0}, IP:"", DefaultGatewayIPv4:net.IP(nil), DefaultGatewayIPv6:net.IP(nil), InterContainerCommunication:true}, EnableIPv6:false, EnableIPTables:true, EnableIPForward:true, EnableIPMasq:true, EnableUserlandProxy:true, UserlandProxyPath:"", FixedCIDRv6:""}, ServiceOptions:registry.ServiceOptions{Mirrors:[]string{"http://f1361db2.m.daocloud.io"}, InsecureRegistries:[]string(nil), V2Only:false}, reloadLock:sync.Mutex{state:0, sema:0x0}, valuesSet:map[string]interface {}{"debug":true, "live-restore":true, "registry-mirrors":[]interface {}{"http://f1361db2.m.daocloud.io"}}, Experimental:false}, CommonUnixConfig:daemon.CommonUnixConfig{ExecRoot:"/var/run/docker", ContainerdAddr:"", Runtimes:map[string]types.Runtime{"runc":types.Runtime{Path:"docker-runc", Args:[]string(nil)}}, DefaultRuntime:"runc"}, CgroupParent:"", EnableSelinuxSupport:false, RemappedRoot:"", Ulimits:map[string]*units.Ulimit(nil), CPURealtimePeriod:0, CPURealtimeRuntime:0, OOMScoreAdjust:-500, Init:false, InitPath:"", SeccompProfile:""}
